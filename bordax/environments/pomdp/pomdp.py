...
class jPOMDP(gymnax.environments.environment.Environment):
    ...
    def __init__(self, pomdp: POMDP):
        ...
        for (a_idx, s_idx, s0_idx, obs_idx), reward in self.init_pomdp.reward.items():
    ...
    def step(self, key, state, action, params):
        ...
        reward = self.reward[action][state[0]][new_state][obs]
...
class BeliefWrapper(GymnaxWrapper):
    ...
    def __init__(self, env: jPOMDP):
        ...
        self.observation_space = gymnax.environments.spaces.Box(
